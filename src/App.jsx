    ...
    <main>
      ...
      <section id="section1">
        <nav>
          ...
          <div className="nav-elem">
            <h5> <i className="ri-arrow-right-s-line"></i> Our Showreel</h5>
          </div>
          <div className="nav-elem">
      ...
      <section id="section4">
        <div className="bottom">
          ...
          <div className="right">
            ...
            <p>
              We’re passionate about moving people and solving problems for the likes of Microsoft, The Museum of Science And Industry Of Chicago, 
              The Kennedy Center of Washington, Dragone, Quanta Magazine, and many more.
            </p>
          </div>
        </div>
        <div className="first-line"></div>
